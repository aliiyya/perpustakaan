				...
				if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
					if($ukuran < 1044070){
			            ...
			            if(move_uploaded_file($file_tmp, $location.$gambar)){
			            	$sql = mysqli_query($coneksi, "UPDATE buku SET judul_buku='$judul_buku', penulis='$penulis', edisi='$edisi', gambar_buku='$gambar', isbn='$isbn' WHERE id_buku='$id_buku'") or die(mysqli_error($coneksi));
			             	if($sql){
