		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				...
				if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
					if($ukuran < 1044070){
					$sql = mysqli_query($coneksi, "INSERT INTO buku(id_buku, judul_buku, penulis, edisi, gambar_buku,isbn,) VALUES('$id_buku', '$judul_buku', '$penulis', '$edisi', '$gambar','$isbn')") or die(mysqli_error($coneksi));
